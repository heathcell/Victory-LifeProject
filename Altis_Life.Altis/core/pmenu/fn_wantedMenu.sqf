...
if !(playerSide isEqualTo independent) exitWith {}; // Only for cops open this menu
...
{
    private _side = switch (side _x) do {case independent: {"Cop"}; case civilian : {"Civ"}; default {"Unknown"};};
