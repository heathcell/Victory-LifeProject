...
if (playerSide != independent) exitWith {hint localize "STR_Cop_wantedList_notCop";};
...
//if (side _unit isEqualTo independent) exitWith {hint "What are ya trying to do, start a police war? Dickhead." };
